      ...
      if(isset($_POST['submit'])){
        ...
        if($emailcount>0){
          ...
          if($mobile>0){
            ...
            $insertquery = "INSERT INTO dk5 (Title, fname, lname, dob, mobile, email, massage, fileupload) 
            values('$Title','$fname','$lname','$dob','$mobile','$email','$massage','$fileupload')";
...
<div class="container">
  ...
  <label for="Title">Title:</label>
    ...
    <input type="text" id="email" name="email id" placeholder="enter your email id" required><br><br>
    </address>
